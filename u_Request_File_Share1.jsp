...
<div class="main">
  ...
  <p>&nbsp;</p>
    ...
    <%
		 ...
		 stmt.executeUpdate("insert into Srequest (user,status,dt,oname) values('"+uname+"','"+status+"','"+dt+"','"+oname+"') ");
		 ...
		 <h2>File Sharing Request Sent Successfully !!! <a href="u_main.jsp">Back</a><h2>
        </div>
      </div>
      <div class="sidebar">
        <div class="gadget">
