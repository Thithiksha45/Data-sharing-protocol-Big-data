...
<div class="main">
  ...
  <p>&nbsp;</p>
          ...
          <p><img src="images/User.jpg" width="564" height="268" /></p>
        </div>
      </div>
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu style9">
			...
			<li><a href="u_search.jsp">Search Patient Data</a></li>
			<li><a href="u_Request_File_Share.jsp">Request File Share</a></li>
						<li><a href="u_download.jsp">Download Patient Data</a></li>
