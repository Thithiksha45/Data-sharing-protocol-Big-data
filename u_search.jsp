...
<div class="main">
  ...
  <p>&nbsp;</p>
       ...
       <form id="form1" name="form1" method="post" action="u_search1.jsp">
            <p>&nbsp;</p>
            <p><span class="style2 style5"><strong>Enter Patient Name or Content Key To Search </strong></span>
              <input required="required" name="keyword" type="text" value="" size="40" />
            </p>
            <p align="center">
              <input type="submit" name="Submit2" value="SEARCH PATIENT REPORT" />
            </p>
          </form>
        </div>
      </div>
