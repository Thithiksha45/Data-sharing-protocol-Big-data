...
<div class="main">
  ...
  <p>&nbsp;</p>
     ...
     <form id="form1" name="form1" method="post" action="u_Request_File_Share1.jsp">
          <table width="598" border="1" align="center" cellpadding="10" cellspacing="0">
            <tr>
            </tr>
            <tr>
			
			  <td><span class="style3">Enter Owner Name</span>
			    <input type="text" name="oname" /></td>
              <td><div align="center">
                <input name="Submit" type="submit" class="style4" value="Request Data Search" />
              </div></td>
            </tr>
          </table>
          </form>
