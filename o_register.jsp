...
.style22 {font-family: "Times New Roman", Times, serif; font-size: 18px; }
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  <p align="center"><img src="images/Register.jpg" width="304" height="78" /><br />
		  </p>
		  <p align="center">&nbsp;</p>
		  <form name="s" action="o_RegIns.jsp" method="post" enctype="multipart/form-data" onSubmit="return valid()"  ons target="_top">
		  
            <p class="style6 style10"><span class="style25">Select Your Group </span><span class="style22">(required)</span><br />
              <br />
                <select name="grp">
                ...
                <label for="name"><span class="style22">Owner Name (required)<br />
                </span></label>
                </span></p>
            <p class="style14"><input id="name" name="userid" class="text" />
            </p>
			
            <span class="style9 style14 style8 style20">
             <label for="password">Password (required)<br />
             </label>
            </span>
            <p class="style14"><input type="password" id="password" name="pass" class="text" /></p>
                  ...
                  <span class="style8 style9 style14 style20">
                  <label for="gender">Select Gender (required)<br />
                  </label>
                  </span>
                  <p class="style8 style9 style20">
                  ...
                  <span class="style19 style9 style14 style23">
                  <label for="pincode">Enter Pincode (required)<br />
                  </label>
                  </span>
                  <p class="style9 style8 style20">
                  ...
                  <span class="style8 style9 style20 style23">
                  <label for="pic"><br />
                  </label>
                  </span>
                  ...
                  <p align="right"><a href="o_login.jsp" class="style8">Back</a></p>
</form>		  
