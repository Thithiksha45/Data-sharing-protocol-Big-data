    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p align="center"><img src="images/Ulogin.jpg" width="195" height="131" /></p>
          <form name="s" action="o_authentication.jsp" method="post" onSubmit="return valid()"  ons target="_top">  
    ...
    <table align="center" border="0" width="51%" height="146">
      ...
      <tr>
        <td height="78" colspan="2"><p align="center">
	        ...
	        <p>&nbsp;</p>
	        <p align="center"><a href="o_register.jsp" class="style7 style3">New User? Register Here</a></p>
</form>		  
