...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> My Profile </span></h2>
		  <p>&nbsp;</p>
...
<table width="565" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
        ...
        <tr>
          <td width="230" rowspan="6" ><div class="style7" style="margin:10px 13px 10px 13px;" ><a class="#" id="img1" href="#" >
              <input  name="image" type="image" src="o_Pic.jsp?id=<%=i%>" style="width:200px; height:200px;">
          </a></div></td>
        </tr>
        ...
        <%
		  ...
		  <p>&nbsp;</p>
                      <p align="right"><a href="o_main.jsp" class="style3 style9">Back</a></p>
          <p>&nbsp;</p>
        </div>
      </div>
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="o_main.jsp"><span>Owner Main</span></a></li>
