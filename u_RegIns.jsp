...
<%
			...
			h1 = bi1.toString(16);
					...
					String sta="waiting";
					PreparedStatement ps=connection.prepareStatement("insert into user(name,pass,email,mobile,addr,dob,gender,pin,location,image,status,acc_type,group1,gkey) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
