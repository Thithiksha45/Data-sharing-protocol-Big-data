...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> Owner Profile </span></h2>
		  <p>&nbsp;</p>
...
<table width="565" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
        ...
        <%
						...
						try 
						{
						   	String query="select * from seller where name='"+user+"'"; 
        ...
        <tr>
          <td width="230" rowspan="6" ><div class="style7" style="margin:10px 13px 10px 13px;" ><a class="#" id="img1" href="#" >
              <input  name="image" type="image" src="s_Pic.jsp?id=<%=i%>" style="width:200px; height:200px;">
          </a></div></td>
        </tr>
		...
		{
		%><p align="right"><a href="a_mal_sellers3.jsp" class="style13">Back</a></p>
        <%
		}
		if(type.equalsIgnoreCase("two"))
		{
		%><p align="right"><a href="aaa.jsp" class="style13">Back</a></p>
        <%
		}
