...
<head>
<title>c_view_key_attackers</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> View Key Attackers</h2>
          <p align="center">&nbsp; </p>
		  
		  
        <table width="639" border="1" align="center" cellspacing="0" cellpadding="5">
  <tr>
    <td  width="39" height="66"  valign="middle" bgcolor="#99CC00" style="color: #2c83b0;"><div align="center" class="style4 style3 style2 style15 style21 style11 style13"><strong><strong>Patient Name</strong></strong></div></td>
    <td  width="72" height="66" valign="middle" bgcolor="#99CC00" style="color: #2c83b0;"><div align="center" class="style4 style3 style2 style15 style21 style11 style13"><strong><strong>Key Used</strong></strong></div></td>
	...
	<%
			...
			try{
			                ...
			                String query="select * from keyattacker"; 
