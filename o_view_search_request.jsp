...
<head>
<title>o_view_search_request</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center">Welcome to Owner Main : <span class="style8"><%=application.getAttribute("owner")%></span></h2><br>
...
<%
  ...
  <tr>
    ...
    <td><div align="center" class="style15"><a href="Search_autorize.jsp?id=<%=i%>"><%=s3%></a></div></td>
