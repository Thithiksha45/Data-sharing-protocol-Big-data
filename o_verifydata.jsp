    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p>&nbsp;</p>
         <form id="form1" name="form1" method="post" action="o_verifydata1.jsp">
          <table width="598" border="1" align="center" cellpadding="10" cellspacing="0">
           
            <tr>
              <td class="style1 style4"><span class="style6">Patient Name :- </span></td>
            ...
            <tr>
              ...
              <td><input name="Submit" type="submit" class="style4" value="Verify Patient Data" /></td>
            </tr>
          </table>
          </form>
          <p align="center">&nbsp;</p>
