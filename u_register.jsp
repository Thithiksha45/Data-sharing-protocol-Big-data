    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  <p align="center">&nbsp;</p>
		  <p align="center"><img src="images/Register.jpg" width="243" height="96" /></p>
		  <form name="s" action="u_RegIns.jsp" method="post" enctype="multipart/form-data" onSubmit="return valid()"  ons target="_top">
		  
		   <p class="style6 style10"><span class="style9"><strong>Select Your Group </strong></span><span class="style22 style9"><strong>(required)</strong></span><br />
              <br />
                <select name="grp">
            ...
            <label for="name"><span class="style22">User Name (required)<br />
            </span></label>
            </span>
		   <p class="style14"><input id="name" name="userid" class="text" />
            ...
            <p class="style14"><input type="password" id="password" name="pass" class="text" /></p>
                  ...
                  <p align="right"><a href="u_login.jsp" class="style8">Back</a></p>
</form>		  
