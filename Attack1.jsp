...
<%
  		...
  		String sk = "";
  		String strQuery = "select * from cloudserver where p1='"
  				+ file + "'";
...
<table width="478" border="0" align="center">
	<tr>
		<td width="223"><span class="style15">Report Name :-</span></td>
		<td width="245"><label> <input required name="t1"
			type="text" value="<%=file%>" size="40" /> </label></td>
	</tr>

	<tr>
		<td height="34"><span class="style15">Ur Name :-</span></td>
		<td><input name="t12" type="text" value="<%=oname%>" size="40" /></td>
	</tr>
		

	<tr>
		<td><span class="style15">Report Content :-</span></td>
